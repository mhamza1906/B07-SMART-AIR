...
public class Step4Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.technique_step4, container, false);

        ImageView gif = v.findViewById(R.id.imgTechniqueStep4);
        Button btnNext = v.findViewById(R.id.btnNext);

        Glide.with(this)
                .asGif()
                .load(R.drawable.technique_step4)
        ...
        btnNext.setOnClickListener(view -> {
            ...
            ((TechniqueHelperActivity) requireActivity())
                    .loadFragment(new Step5Fragment());
        });

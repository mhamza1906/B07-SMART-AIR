...
public class Step2EmptyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.technique_step2_if_empty, container, false);

        ImageView gif = v.findViewById(R.id.imgTechniqueStep2Empty);
        Button btnNext = v.findViewById(R.id.btnNext);

        Glide.with(this)
                .asGif()
                .load(R.drawable.technique_step2_if_empty)
        ...
        btnNext.setOnClickListener(view -> {
            ...
            ((TechniqueHelperActivity) requireActivity())
                    .loadFragment(new Step3EmptyFragment());
        });

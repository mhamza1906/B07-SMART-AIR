...
public class Step6Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.technique_step6, container, false);

        ImageView gif = v.findViewById(R.id.imgTechniqueStep6);
        Button btnNext = v.findViewById(R.id.btnNext);

        Glide.with(this)
                .asGif()
                .load(R.drawable.technique_step6)
                .diskCacheStrategy(DiskCacheStrategy.NONE)
                .skipMemoryCache(true)
                .into(gif);

        CooldownHelper.startCooldown(6500, () -> cooler1 = true);
        ...
        btnNext.setOnClickListener(view -> {
            ...
            ((TechniqueHelperActivity) requireActivity())
                    .loadFragment(new Step7Fragment());
        });

...
public class Step5Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.technique_step5, container, false);

        ImageView gif = v.findViewById(R.id.imgTechniqueStep5);
        Button btnNext = v.findViewById(R.id.btnNext);

        Glide.with(this)
                .asGif()
                .load(R.drawable.technique_step5)
        ...
        btnNext.setOnClickListener(view -> {
            ...
            ((TechniqueHelperActivity) requireActivity())
                    .loadFragment(new Step6Fragment());
        });
